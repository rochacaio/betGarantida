...
- Validação concluída com 82 testes da API, 21 testes do motor, lint de todos os
...
## Extensão — green antecipado e duplo green

Status: implementada e validada.

- Linhas pagas antecipadamente podem ser registradas como green enquanto a
  operação continua aberta.
- O retorno entra imediatamente no saldo da casa e a linha deixa de compor o
  valor em apostas.
- A linha fica bloqueada como green já creditado e não recebe um segundo retorno
